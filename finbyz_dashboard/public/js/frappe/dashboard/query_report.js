...
frappe.views.QueryReport = class QueryReport extends frappe.views.BaseList {
	...
	create_number_card(values, dashboard_name, card_name, set_standard) {
		...
		this.add_to_dashboard(
			'finbyz_dashboard.finbyz_dashboard.doctype.number_card.number_card.create_report_number_card',
			args,
			dashboard_name,
			card_name,
			'Number Card'
	...
	create_dashboard_chart(chart_args, dashboard_name, chart_name, set_standard) {
		...
		this.add_to_dashboard(
			'finbyz_dashboard.finbyz_dashboard.dashboard_overrides.dashboard_chart.create_report_chart',
			args,
			dashboard_name,
			chart_name,
			'Dashboard Chart'
