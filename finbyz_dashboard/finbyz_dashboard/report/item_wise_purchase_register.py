...
def _execute(filters=None, additional_table_columns=None, additional_query_columns=None):
	...
	return columns, data, None, chart_data, None, skip_total_row
...
def get_chart_data(data, filters):
	...
	for row in data:
		try:
			...
			continue
	data = [row for row in lst_data if row['item_group'] == filters.get('item_group')]
	data = sorted(data, key = lambda i: i['stock_qty'],reverse=True)
	...
	for row in data:
		...
		datapoints.append(row['stock_qty'])
